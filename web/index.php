            ...
            <div class="row">
                <div class="col-md-5  opaline col-md-offset-6 col-sm-offset-6 block2-bg">
                	...
                	<div class="block2-text">
                      <h5 class="wow bounceInRight" data-wow-delay="0.5s">Если вы ищете, чем заняться в зимние выходные, попробуйте катание на сноуборде.</h5>
                      <p class="wow bounceInRight" data-wow-delay="0.8s">Совсем не обязательно сразу покупать дорогие профессиональные вещи (вдруг вам не понравится кататься, в итоге их придётся продавать или дарить), все снаряжение можно взять у нас=)</p>
                  </div>
                </div>
            </div>  
    </div>
